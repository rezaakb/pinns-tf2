...
def plot_kdv(mesh, preds, train_datasets, val_dataset, file_name):
    ...
    x0 = train_datasets[0].spatial_domain_sampled[0].numpy()
    u0 = train_datasets[0].solution_sampled[0].numpy()
    idx_t0 = train_datasets[0].idx_t
    x1 = train_datasets[1].spatial_domain_sampled[0].numpy()
    u1 = train_datasets[1].solution_sampled[0].numpy()
